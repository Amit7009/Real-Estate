...
<%
	...
	List<Property> l=bl.searchpropertyList(email);
					...
					<table data-toggle="table" data-url="tables/data1.json"
						...
						<thead>
							<tr>
								...
								<th data-field="id7" data-sortable="true">Action</th>
								<th data-field="id8" data-sortable="true">Action</th>
							</tr>
						</thead>
						<c:forEach items="${sessionScope.List1}" var="l">
							<tr>
								...
								<td data-field="id7" data-sortable="true"><a href="UpdateProperty?pid=${l.pid}" style="color: #30a5ff;">Update</a></td>
								<td data-field="id8" data-sortable="true"><a href="DeleteProperty?pid=${l.pid}" style="color: #30a5ff;">Delete</a></td>
